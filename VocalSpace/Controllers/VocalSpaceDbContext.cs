...
public partial class VocalSpaceDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AuthorityId).HasName("PK__Authorit__433B1E6D84045B06");
        ...
        modelBuilder.Entity<PlayHistory>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.UserId, e.SongId }, "UQ_PlayHistory").IsUnique();
        ...
        modelBuilder.Entity<PlayList>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ_PlayList").IsUnique();
        ...
        {
            entity.HasKey(e => e.SongCategoryId).HasName("PK__SongCate__BD6CF5D96618AE24");
